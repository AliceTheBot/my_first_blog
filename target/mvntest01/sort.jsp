...
<body>
            ...
            <div class="row">
               <div class="col-lg-8 col-md-10 mx-auto">
                  <div class="site-heading">
                       <h1 class="preface">为什么不问问神奇的目录呢</h1>
                  </div>
               </div>
         </div>
      </div>
    ...
    <div class="container-fluid">
       <div class="row">
           ...
           <div class="col-lg-8 col-lg-offset-1">
                <c:forEach var="item" items="${requestScope.sort_art}">
                    <h2 id="${item.key}"><span class="glyphicon glyphicon-tasks"></span>${item.key}</h2>
                    <ul class="sort">
    ...
    <script type="text/javascript">
        var this_sort="${requestScope.this_sort}";
        if(this_sort.trim().length>0)
            document.getElementById(this_sort).scrollIntoView();
    </script>
</body>
</html>
