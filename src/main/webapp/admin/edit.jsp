...
<body>
	...
	<div class="container" id="main">		
		   ...
		   <form action="UpdateServlet" method="post">
		   		...
		   		<input type="text" class="form-control"  value="${requestScope.edit_article.id}" disabled="disabled">
				<input type="hidden" class="form-control" name="id"  value="${requestScope.edit_article.id}">
		   		<!-- title -->
		   		<span class="help">标题</span>
		   		<input type="text" class="form-control" name="title"  value="${requestScope.edit_article.title}">
		   		<!-- time -->
		   		<span class="help">时间</span>
		   		<input type="text"  class="form-control" name="time" value="${requestScope.edit_article.time}" >
		   		<!-- author-->
		   		<span class="help">作者</span>
		   		<input type="text" class="form-control" name="author" value="${requestScope.edit_article.author}">
		   		<!-- sort --> 				
 				...
 				<input type="text" class="form-control"  id="sort" name="sort" value="${requestScope.edit_article.sort}">
                ...
                <div class="editormd" id="mdView">                
                    <textarea name="mdView-markdown-doc" style="display:none;">${requestScope.edit_article.content}</textarea>
                </div>
                <br/>
